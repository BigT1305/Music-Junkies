...
HD_PWD='X:/SLU/_CMPS 375/repo/DispAlu4/DispAlu4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DispAlu4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DispAlu4.tcl -notrace
