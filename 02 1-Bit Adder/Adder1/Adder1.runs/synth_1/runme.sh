...
HD_PWD='Y:/Google Drive/SLU/_CMPS 375/_units/02_ vivado 1bit adder/Adder1/Adder1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Adder1.tcl
