...
HD_PWD='Y:/Google Drive/SLU/_CMPS 375/_units/02_ vivado 1bit adder/Adder1/Adder1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Adder1.tcl -notrace
