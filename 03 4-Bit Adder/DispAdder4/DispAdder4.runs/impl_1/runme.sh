...
HD_PWD='Y:/Google Drive/SLU/_CMPS 375/_units/03_ vivado 4bit adder/DispAdder4/DispAdder4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DispAdder4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DispAdder4.tcl -notrace
